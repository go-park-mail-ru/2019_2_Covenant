...
func (sh *SessionHandler) CreateSession() echo.HandlerFunc {
	...
	return func(c echo.Context) error {
		...
		usr, err := sh.UUsecase.GetByEmail(c.Request().Context(), request.Email)
		...
		if err = sh.SUsecase.Store(c.Request().Context(), sess); err != nil {
...
func (sh *SessionHandler) DeleteSession() echo.HandlerFunc {
	return func(c echo.Context) error {
		...
		if err := sh.SUsecase.DeleteByID(c.Request().Context(), sess.ID); err != nil {
