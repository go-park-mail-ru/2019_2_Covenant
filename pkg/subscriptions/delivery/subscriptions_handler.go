...
func (sh *SubscriptionHandler) GetSubscriptions() echo.HandlerFunc {
	...
	return func(c echo.Context) error {
		...
		followers, totalFollowers, err := sh.UUsecase.GetFollowers(c.Request().Context(), sess.UserID, request.Count, request.Offset)
		...
		following, totalFollowing, err := sh.UUsecase.GetFollowing(c.Request().Context(), sess.UserID, request.Count, request.Offset)
